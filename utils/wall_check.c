...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/14 11:41:30 by fgabler           #+#    #+#             */
/*   Updated: 2023/08/14 11:46:41 by fgabler          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../include/so_long.h"

static t_box	get_corners_of_block(
					mlx_instance_t *instances, int move_y, int move_x);
